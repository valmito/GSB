...
return [
    ...
    'upd_route' => [['id'], ['_controller' => 'App\\Controller\\FicheFraisController::updateAction'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/article/update']], [], []],
    'r_register' => [[], ['_controller' => 'App\\Controller\\FicheFraisController::register'], [], [['text', '/article/update/register']], [], []],
    'verif_del_art' => [['id'], ['_controller' => 'App\\Controller\\FicheFraisController::deleteVerif'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/article/verif/supprimer']], [], []],
