...
return [
    ...
    'del_art' => [['id'], ['_controller' => 'App\\Controller\\FicheFraisController::deleterFicheFrais'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/fiche/frais/supprimer']], [], []],
    ...
    'Accueil' => [[], ['_controller' => 'App\\Controller\\UserController::seConnecter'], [], [['text', '/']], [], []],
