...
// Returns the private 'App\Repository\ConnexionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ConnexionRepository.php';

return $this->privates['App\\Repository\\ConnexionRepository'] = new \App\Repository\ConnexionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
