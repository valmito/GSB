...
// Returns the private 'App\Repository\LigneFaisRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LigneFaisRepository.php';

return $this->privates['App\\Repository\\LigneFaisRepository'] = new \App\Repository\LigneFaisRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
