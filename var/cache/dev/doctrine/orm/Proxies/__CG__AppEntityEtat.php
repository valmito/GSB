...
class Etat extends \App\Entity\Etat implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Etat' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Etat' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\Etat' . "\0" . 'ficheFrais'];
        }
     ...
     * {@inheritDoc}
     */
    public function addFicheFrai(\App\Entity\FicheFrais $ficheFrai): \App\Entity\Etat
    {
     ...
     * {@inheritDoc}
     */
    public function removeFicheFrai(\App\Entity\FicheFrais $ficheFrai): \App\Entity\Etat
    {
