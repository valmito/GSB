...
<html>
    ...
    public function block_icon($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/GSB.jpeg"), "html", null, true);
        echo "\" />";
...
<html>
    <head>
        ...
        {% endblock %}
        {% block icon %}<link rel=\"icon\" type=\"image/x-icon\" href=\"{{ asset('img/GSB.jpeg') }}\" />{% endblock %}
    </head>
    {% block menu%}
    <body>
